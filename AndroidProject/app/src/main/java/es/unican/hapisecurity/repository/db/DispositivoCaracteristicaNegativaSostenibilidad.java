...
@Entity(tableName = "dispositivo_caracteristica_negativa_sostenibilidad",
        primaryKeys = {"dispositivoId", "caracteristicaId"})
public class DispositivoCaracteristicaNegativaSostenibilidad {
    ...
    public DispositivoCaracteristicaNegativaSostenibilidad() {
        this.dispositivoId = "";
