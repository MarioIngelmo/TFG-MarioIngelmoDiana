...
class LoadDatabase {
	...
	CommandLineRunner initDatabase(DispositivoRepository repositoryDispositivos,
		...
		return args -> {
			...
			log.info("Preloading " + repositoryDispositivos.save(new Dispositivo("1223432594567536",
			...
			log.info("Preloading " + repositoryDispositivos.save(new Dispositivo("65346536653",
			...
			log.info("Preloading " + repositoryDispositivos.save(new Dispositivo("65886786545684",
